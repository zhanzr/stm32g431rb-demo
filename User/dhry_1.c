...
RAM_CODE void Proc_1 (Rec_Pointer Ptr_Val_Par)
/******************/
    /* executed once */
{
...
RAM_CODE void Proc_2 (One_Fifty *Int_Par_Ref)
/******************/
    /* executed once */
...
RAM_CODE void Proc_3 (Rec_Pointer *Ptr_Ref_Par)
/******************/
    /* executed once */
...
RAM_CODE void Proc_4 (void) /* without parameters */
/*******/
    /* executed once */
{
  Boolean Bool_Loc;
...
RAM_CODE void Proc_5 (void) /* without parameters */
/*******/
    /* executed once */
{
  Ch_1_Glob = 'A';
...
RAM_CODE void dhry_main(uint32_t freq) {
	One_Fifty       Int_1_Loc;
